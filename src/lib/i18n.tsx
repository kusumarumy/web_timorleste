...
export const DICTS: Record<Lang, Dict> = {
  id: {
    ...
    l_oe09_po_teks: "Teks",
    l_oe09_po_teksbm: "Teks BM (Titik)",
  ...
  pt: {
    ...
    l_oe09_po_teksbm: "Texto BM (Ponto)",
