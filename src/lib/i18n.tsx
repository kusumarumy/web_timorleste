...
export const DICTS: Record<Lang, Dict> = {
  id: {
    ...
    irrigation_unidentified: "Belum Teridentifikasi",
    irrigation_pembuang: "Pembuang",
    irrigation_primer: "Primer",
    irrigation_sekunder: "Sekunder",
    l_4schema: "Klasifikasi Hidrologi",
    l_4schema_oebaba: "Oebaba",
    l_4schema_luan_kadoe: "Luan Kadoe, Akadiru Kede, & Kakeulaku",
    l_4schema_paulata_lias: "Paulata & Lias",
    l_4schema_raibere_buiha: "Raibere & Buiha",
    ...
    di_raibere: "Raibere",
    di_oebaba: "Oebaba",
    irrigation_functional: "Fungsional",
    irrigation_potential: "Potensial",
    irrigation_crop_plantation: "Crop Plantation",
    ...
    l_rei09_ar_bmcp: "Bench Mark & Control Point",
    ...
    l_rei09_li_linepol: "Garis Poligon",
    ...
    profile_max: "Titik tertinggi",
    profile_min: "Titik terendah",
  ...
  en: {
    ...
    irrigation_unidentified: "Unidentified",
    irrigation_pembuang: "Drainage",
    irrigation_primer: "Primary",
    irrigation_sekunder: "Secondary",
    l_4schema: "Hydrological Classification",
    l_4schema_oebaba: "Oebaba",
    l_4schema_luan_kadoe: "Luan Kadoe, Akadiru Kede, & Kakeulaku",
    l_4schema_paulata_lias: "Paulata & Lias",
    l_4schema_raibere_buiha: "Raibere & Buiha",
    ...
    di_raibere: "Raibere",
    di_oebaba: "Oebaba",
    irrigation_functional: "Functional",
    irrigation_potential: "Potential",
    irrigation_crop_plantation: "Crop Plantation",
    ...
    l_oe09_li_bmcp: "Bench Mark & Control Point",
    ...
    l_rei09_ar_bmcp: "Referência & Ponto de Controlo",
    ...
    profile_loss: "Total descent",
    profile_max_slope: "Max slope",
  ...
  pt: {
    ...
    irrigation_unidentified: "Não Identificado",
    irrigation_pembuang: "Drenagem",
    irrigation_primer: "Primário",
    irrigation_sekunder: "Secundário",
    l_4schema: "Classificação Hidrológica",
    l_4schema_oebaba: "Oebaba",
    l_4schema_luan_kadoe: "Luan Kadoe, Akadiru Kede, & Kakeulaku",
    l_4schema_paulata_lias: "Paulata & Lias",
    l_4schema_raibere_buiha: "Raibere & Buiha",
    ...
    di_raibere: "Raibere",
    di_oebaba: "Oebaba",
    irrigation_functional: "Funcional",
    irrigation_potential: "Potencial",
    irrigation_crop_plantation: "Plantação Agrícola",
    ...
    slope: "Declive",
    area: "Área",
    profile_title: "Perfil de Elevação",
    ...
    profile_loss: "Descida total",
    profile_max_slope: "Declive máx.",
