  ...
  layers: [
    
    {
      ...
      children: [
        ...
        {
          // NOTE: kalau file kontur besar, pindahkan ke R2 -> ganti v(...) jadi r2Vector(...)
          id: "oe09_li_contourmayor",
          nameKey: "l_oe09_li_contourmayor",
          kind: "line",
          data: v("09_oe_li_contourmayor"),
          clickable: true,
          lazy: true,
          paint: { "line-color": "#92400E", "line-width": 1.6, "line-opacity": 0.9 },
          defaultOn: false,
          legend: { color: "#92400E", line: true },
        },
        {
          id: "oe09_li_contourminor",
          nameKey: "l_oe09_li_contourminor",
          kind: "line",
          data: v("09_oe_li_contourminor"),
          clickable: true,
          lazy: true,
          paint: { "line-color": "#A16207", "line-width": 1, "line-opacity": 0.8 },
          defaultOn: false,
          legend: { color: "#A16207", line: true },
        },
        {
